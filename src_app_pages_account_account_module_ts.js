...
let MyPropertiesComponent = class MyPropertiesComponent {
    constructor(appService) {
        this.appService = appService;
        this.displayedColumns = ['id', 'image', 'titre', 'publié', 'vues', 'actions'];
    }
    ngOnInit() {
