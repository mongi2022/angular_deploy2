...
let AppService = class AppService {
    ...
    getPropertyById(id) {
        return this.http.get('http://localhost:3000/property/' + id);
    }
    ...
    getCities() {
        return this.http.get('http://localhost:3000/ville');
    }
    getNeighborhoodByCityId(id) {
        return this.http.get(`http://localhost:3000/neighborhood/region/${id}`);
    }
    getNeighborhoods() {
    ...
    getTestimonials() {
        return this.http.get('http://localhost:3000/testimonial');
    }
    getFeatureList() {
        return this.http.get('http://localhost:3000/featurelist');
    }
    getAgents() {
        return this.http.get('http://localhost:3000/agent');
    }
    getAgentById(id) {
        return this.http.get(`http://localhost:3000/agent/${id}`);
    }
    getClients() {
